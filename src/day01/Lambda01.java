...
*/
        ...
        System.out.println("\n***");
        printCiftOtzKckElFunctional(sayi);
        System.out.println("\n***");
        printCiftVeyaOtzBykElFunctional(sayi);
        System.out.println("\n***");
 ...
 */
    ...
    public static void yazdir(int a){//verilen int degeri ayni satirda bosluk birakarak  yazdirma action yapan seed(tohum)method
        System.out.print(a+" ");
    }
    ...
    //Task: structured Programming ile list elemanlarinin 34den kucuk cift olanalrini ayni satirda aralarina bosluk birakarak print ediniz
    public static void printCiftOtzKckElFunctional(List<Integer>sayi){
        sayi.
                stream().
                //filter(t->t%2==0 &&t<34).
...
//Task : functional Programming ile list elemanlarinin 34 den buyk veya cift olanalrini
// ayni satirda aralarina bosluk birakarak print ediniz.
public static void printCiftVeyaOtzBykElFunctional(List<Integer>sayi){
    sayi.
            stream().
